                ...
                <div className="col-lg-12 col-md-10 mx-auto">
                    <form className="user" onSubmit={handleSubmit}>
                        <div className="form-group">
                            <input type="text" onChange={handleInputChange}  value={inputs.nombre?inputs.nombre:''} className="form-control form-control-user border-left-danger" name="nombre" placeholder="Nombre Línea de Tranporte" required={true} />
                        </div>
                        <div className="form-group">
...
export default authHOC(LineaTransporteCreate);